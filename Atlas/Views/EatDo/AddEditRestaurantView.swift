...
struct AddEditRestaurantView: View {
    ...
    @State private var category = "American"
    ...
    private var headerView: some View {
        HStack {
            ...
            VStack(spacing: 4) {
                ...
                Text("Share your favorite place")
        ...
        VStack(alignment: .leading, spacing: AtlasTheme.Spacing.md) {
            ...
            ScrollView(.horizontal, showsIndicators: false) {
                HStack(spacing: AtlasTheme.Spacing.sm) {
                    ForEach(EatDoCategories.restaurantCategories, id: \.self) { cat in
                        Button(action: {
                            AtlasTheme.Haptics.selection()
                            category = cat
                        }) {
    ...
    private var submitButton: some View {
        Button(action: submitRestaurant) {
            HStack(spacing: AtlasTheme.Spacing.sm) {
                ...
                Text(isSubmitting ? "Adding..." : "Add Restaurant")
